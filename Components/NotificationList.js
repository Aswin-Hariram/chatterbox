...
const NotificationList = ({ data, setAllData }) => {
        ...
        <View style={{ marginTop: 15 }}>
            ...
            <View style={styles.contact}>
                ...
                <TouchableOpacity onPress={() => {
                    Alert.alert("Accept Request", `Do you want to accept ${data.username} request??`, [
                        {
                            text: "No",
                            onPress: () => { }
                        },
                ...
                }} style={{ borderWidth: 0.5, borderRadius: 50, padding: 10, marginRight: 10, backgroundColor: "#68be80", borderColor: "white" }}>
                    <MaterialIcons name="done" size={24} color="white" />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => {
                    Alert.alert("Reject Request", `Do you want to reject the ${data.username} request?`, [
                        {
                            text: "Yes",
                            onPress: () => { handleAcceptReject("Rejected") }
                        },
                        {
                            text: "No",
                        }
